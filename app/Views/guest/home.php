...
<div id="heroCarousel" class="carousel slide anim-fade-up" data-bs-ride="carousel" style="margin-bottom: 5rem;">
    ...
    <div class="carousel-inner" style="height: 520px;">
        ...
        <div class="carousel-item active" style="height: 100%;">
            ...
            <div class="carousel-caption d-md-block glass-panel p-4" style="border-radius: 12px; max-width: 600px; margin: 0 auto 40px auto; bottom: 20px;">
                ...
                <a class="btn btn-gold btn-sm text-uppercase" href="/menu#chicken">Lihat Detail</a>
            </div>
        </div>
        <!-- Slide 2 -->
        <div class="carousel-item" style="height: 100%;">
            ...
            <div class="carousel-caption d-md-block glass-panel p-4" style="border-radius: 12px; max-width: 600px; margin: 0 auto 40px auto; bottom: 20px;">
                ...
                <a class="btn btn-gold btn-sm text-uppercase" href="/menu#pork">Lihat Detail</a>
            </div>
        </div>
        <!-- Slide 3 -->
        <div class="carousel-item" style="height: 100%;">
            ...
            <div class="carousel-caption d-md-block glass-panel p-4" style="border-radius: 12px; max-width: 600px; margin: 0 auto 40px auto; bottom: 20px;">
                ...
                <a class="btn btn-gold btn-sm text-uppercase" href="/menu#seafood">Lihat Detail</a>
            </div>
        </div>
    </div>
...
<div class="container my-5" id="about-us">
    <div class="text-center mb-5">
        <h2 class="category-title-border text-uppercase"><span class="gold-text">Tentang Kami</span></h2>
    </div>
        ...
        <div class="col-md-6">
            <div class="p-4 glass-panel" style="border-radius: 16px;">
                ...
                <p class="text-secondary small">
                    Hasilnya adalah ayam yang harum, empuk, dan lezat — rasa ayam asli dicapai tanpa jalan pintas atau bahan sintetis. Disajikan bersama nasi gurih dan saus segar buatan rumah yang telah kami sempurnakan selama puluhan tahun.
                </p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="p-4 glass-panel" style="border-radius: 16px;">
                ...
                <p class="text-secondary small">
                    Hingga hari ini, kami hanya menerima pasokan terbaik karena kami memahami perbedaannya. Nikmati hidangan Five Star Signatures yang secara khusus diciptakan untuk memanjakan lidah Anda.
                </p>
            </div>
        </div>
    </div>
...
<!-- SECTION: CATEGORIES QUICK NAV -->
<div class="container my-5" id="menu">
    <div class="text-center mb-5">
        <h2 class="category-title-border text-uppercase"><span class="gold-text">Kategori Menu</span></h2>
    </div>
    <div class="row row-cols-2 row-cols-md-4 g-3 text-center">
        <div class="col">
            <a href="/menu#chicken" class="text-decoration-none" style="color: var(--text-primary);">
        ...
        <div class="col">
            <a href="/menu#pork" class="text-decoration-none" style="color: var(--text-primary);">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#omelette" class="text-decoration-none" style="color: var(--text-primary);">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#fish" class="text-decoration-none" style="color: var(--text-primary);">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#seafood" class="text-decoration-none" style="color: var(--text-primary);">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#vegetables" class="text-decoration-none" style="color: var(--text-primary);">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#srn" class="text-decoration-none" style="color: var(--text-primary);">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#dnb" class="text-decoration-none" style="color: var(--text-primary);">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
...
<div class="container my-5 text-center" id="franchise" style="padding-top: 40px;">
    <div class="glass-panel franchise-banner p-5" style="border-radius: 20px;">
        ...
        <span class="badge btn-crimson px-4 py-2 fs-6 text-uppercase" style="border-radius: 30px;">Kemitraan Segera Hadir</span>
    </div>
</div>
