...
<div class="container my-5" id="menu">
    ...
    <div class="row row-cols-2 row-cols-md-4 g-3 text-center">
        <div class="col">
            <a href="/menu#chicken" class="text-decoration-none text-light">
        ...
        <div class="col">
            <a href="/menu#pork" class="text-decoration-none text-light">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#omelette" class="text-decoration-none text-light">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#fish" class="text-decoration-none text-light">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#seafood" class="text-decoration-none text-light">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#vegetables" class="text-decoration-none text-light">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#srn" class="text-decoration-none text-light">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
        ...
        <div class="col">
            <a href="/menu#dnb" class="text-decoration-none text-light">
                <div class="p-3 glass-panel h-100 hover-border-gold" style="border-radius: 12px;">
